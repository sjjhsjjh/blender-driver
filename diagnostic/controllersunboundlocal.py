...
-   A local variable set when the controllers module is imported.
-   Failed attempt to modify the value of the local variable.

This approach doesn't work. It raises an exception. The current best working
approach is illustrated in the controllerscontext.py file in this directory.
...
def initialise(controller):
    ...
    try:
        ...
        #
        # The presence of the next line causes the previous line to generate
        # UnboundLocalError.
        #
        counter = counter + 1
        print('initialise 1', counter)
    except:
